<form wire:submit.prevent="createSolicitud" class="form-horizontal" novalidate enctype="multipart/form-data">
    ...
    <div style="z-index:9900" class="bg-secondary rounded-3 p-2 m-1 col-12">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="bg-secondary rounded-3 p-2 m-1  col-md-12 mt-2">
        <label class="form-label">Seleccionar Materias</label><br>
        <button type="button" class="btn btn-warning w-100" wire:click='seleccionarMaterias'>
            Seleccionar Materias
            <?php if($materiasSeleccionadas == null): ?>
                <i class="fas fa-plus"></i>
            <?php else: ?>
                <span class="badge bg-white text-dark">
                    <?php echo e(count($materiasSeleccionadas)); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="bg-secondary rounded-3 p-2 m-1 col-12">
        ...
        <textarea placeholder="Escribe una descripción de su solicitud ✍🏻" wire:model="descripcion" class="form-control"
            rows="3"></textarea>
...
<?php echo $__env->make('livewire.licencia.modalMateria', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\Users\wilder poma flores\Documents\MI REPOSITORIO\sistemaDeLicencias_Gustavo\resources\views/livewire/licencia/create.blade.php ENDPATH**/ ?>