...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="modal-footer">
                <div class="d-grid gap-2 col-10 mx-auto bg-success ">
                    <button type="submit" value="enviar" class="btn btn-store">Registrar</button>
                </div>
            </div>
            </form>
        </div>
...
<?php /**PATH C:\Users\HP\Documents\REPOSITORIO\sistemaDeLicencias_Gustavo\resources\views/livewire/padre/update.blade.php ENDPATH**/ ?>