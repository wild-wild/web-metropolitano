...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            $('#viewLicenciasSolicitadas').modal('show'); // Reemplaza 'miModal' con el ID de tu modal
        });
    </script>
<?php $__env->stopPush(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\HP\Documents\REPOSITORIO\sistemaDeLicencias_Gustavo\resources\views/livewire/licencia/index.blade.php ENDPATH**/ ?>