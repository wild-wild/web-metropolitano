<div wire:ignore.self class="modal fade" id="createRol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <b>REGISTRAR NUEVO ROL</b>
                </h5>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="modal-footer">
                        <div class="d-grid gap-2 col-10 mx-auto">
                            <button type="submit" class="btn bg-success close-modal">Registrar</button>
                        </div>
                    </div>
                </form>
            </div>
...
</div><?php /**PATH C:\Users\wilder poma flores\Documents\MI REPOSITORIO\plantilla admin LTE\plantilla\resources\views/livewire/role/create.blade.php ENDPATH**/ ?>