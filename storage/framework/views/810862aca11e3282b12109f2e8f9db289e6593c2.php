    ...
    <div class="table-responsive">
        ...
        <table border="1" class="table default" width="100%"style="text-align: left;">
            <tr>
                <td width="50%">
                    <b>Apellido Paterno:
                    </b> <?php echo e($estudiante->apellidos); ?>

                    </b>
                </td>
                <td width="50%">
                    <b>Nombres: </b> <?php echo e($estudiante->nombres); ?>
        ...
        <table border="1" class="table default" width="100%"style="text-align: left;border-radius:10px;">
            <tbody>
                <tr>
                    <td width="50%">
                        <b>Grado: <?php echo e($curso->nombre); ?></b>
                    </td>
                    <td width="50%">
        ...
        <table border="1" class="table default" width="100%">
            <tr style="text-align: left; height: 30px">
                <td width="50%"><b>Motivo:</b> <?php echo e($licencia->motivo); ?>

                </td>
                <td width="50%"><b>Descripción Motivo:</b> <?php echo e($licencia->descripcion); ?>

                </td>
                <tr>
                    <td class="textIzq" colspan="4"><span><b>Tiempo de Licencia: <?php echo e($licencia->tiempoLicencia); ?>
        ...
        <table border="1" class="table default" width="100%"style="text-align: left;">
            <tr>
                ...
                <td width="50%">
                    <b>Nombres: <?php echo e($userSolicitante->name); ?></b>
                </td>
            </tr>
        </table>
        <table class="table default" width="100%" cellspacing="0" cellpadding="0" border="1"
        ...
        <table border="1" class="table default" width="100%"style="text-align: left;">
            <tr>
                <td width="50%">
                    <b>Nombres y Apellidos: <?php echo e($licencia->usuarioAcepto); ?></b>
                </td>
                </td>
                <td width="50%">
...
<?php /**PATH C:\Users\wilder poma flores\Documents\MI REPOSITORIO\sistemaDeLicencias_Gustavo\resources\views/livewire/licencia/reporteLicencia.blade.php ENDPATH**/ ?>